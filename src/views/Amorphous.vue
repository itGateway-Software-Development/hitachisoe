<template>
  <div class="amorphous">
    <div class="img d-flex justify-content-center my-4">
      <!-- <img src="@/assets/images/amorphous/amorphous.png" alt="" /> -->
      <vue-image-zoomer regular="/amorphous.png" />
    </div>
    <br />
    <br />
    ...
    <p>
      In a transformer there are two types of losses which are generated during operation: No load loss and Load loss. The Amorphous material has great advantage in reducing No load loss and the amorphous metal transformer can reduce 70 to 80% No load Loss lower than the conventional type of transformer. The main application of amorphous metal Transformer is in the grid distribution transformers, and the No-Load loss of these transformers makes up a significant part of the loss of the whole distribution network. 
    </p>
    <p>
