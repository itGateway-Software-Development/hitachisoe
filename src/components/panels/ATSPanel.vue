      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <tr data-aos="flip-up">
            ...
            <td class="text-center" colspan="2">63A to 6300A</td>
          </tr>
          <tr data-aos="flip-up">
            <td>Rated Voltage</td>
          ...
          <tr data-aos="flip-up">
            ...
            <td class="text-center">V</td>
            <td class="text-center" colspan="2">690V</td>
          </tr>
          <tr data-aos="flip-up">
          ...
          <tr data-aos="flip-up">
            ...
            <td class="text-center" colspan="2">2 / 3 / 4</td>
          </tr>
          <tr data-aos="flip-up">
          ...
          <tr data-aos="flip-up">
            ...
            <td class="text-center">IEC 61439</td>
          </tr>
          <tr data-aos="flip-up">
